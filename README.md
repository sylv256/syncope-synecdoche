...
This project is licensed under MPL 2.0 except assets in
`src/*/resources/assets/*` directories where the asterisk (*) denotes any name
or number of directories therein.

Assets in `src/*/resources/assets/*` are All Rights Reserved.
